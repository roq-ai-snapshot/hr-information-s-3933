  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="HR Information System: Streamlining Your HR Processes - Efficiently Manage Employee Data, Vacations, and Payroll in One Place"
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1531545514256-b1400bc00f31?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxocnxlbnwwfHx8fDE2OTg2NTc3NjJ8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`HR Information System: Streamlining Your HR Processes - Efficiently Manage Employee Data, Vacations, and Payroll in One Place`}
            </Text>
            <Box
